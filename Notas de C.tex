...
\begin{document}
	...
	*n = *n * *n * *n;
	...
	El siguiente pasao en terminos de complexidad y poder, estan las funciones \textbf{gets()} y \textbf{puts()}. Estos permiten leer y escribir cadenas de caracteres en la consola.
	
	La funcion \textbf{gets()} lee una cadena de caracteres entradas 
